...
| `postWorkspaceCreation` | `string` | `""` | Shell command run in the workspace directory immediately after workspace creation and before the implementation agent runs. |
