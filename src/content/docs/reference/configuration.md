...
kipppunkt reads runtime configuration from an optional JSON file.
...
| `postWorkspaceCreation` | `string` | `""` | Shell command run in the workspace directory immediately after workspace creation and before the implement agent runs. |
