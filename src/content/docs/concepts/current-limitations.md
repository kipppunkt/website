...
Current AI harness sandboxes are either too restrictive, not restrictive enough, or not supported at all ([#26](https://github.com/kipppunkt/build/issues/26)). In practice, this means you should run kipp•punkt inside a [Docker container](/reference/sandbox-with-docker) to get a meaningful security boundary — or accept the risk of running the agent with full access to your machine.
